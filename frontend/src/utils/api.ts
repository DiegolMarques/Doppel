...
import { auth } from "/Users/diegomarques/Desktop/doppel_folder/Doppel/frontend/src/utils/firebase.ts";
...
const handleRequest = async (
  ...
  const response = await fetch("http://localhost:8000" + url, options); //replace with BASE_URL
